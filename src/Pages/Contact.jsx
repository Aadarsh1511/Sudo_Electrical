...
import 'aos/dist/aos.css';
 ...
 const Contact=()=> {
  ...
  <div className="bg-gray-900 rounded-b-lg md:rounded-r-lg md:rounded-bl-none w-full md:w-[600px] gap-4 flex flex-col md:flex-row items-center justify-center md:justify-end pr-0 md:pr-6 pt-3 md:pt-0 py-4">
    <Button className="border border-white text-[17px] w-3/4 md:w-auto">Track Complaint</Button>
    <Button className="border border-white text-[17px] w-3/4 md:w-auto">Register Complaint</Button>
  </div>
</div>
  ...
  <p className="text-center mb-8 md:mb-10 text-gray-300">
