...
const WaterHeaters = ()=> {
  ...
  return (
    ...
    <section className="py-12 px-4 pt-20 md:px-10 bg-[#f8f4ee]">
    ...
    <section className="relative py-12 bg-[#f8f4ee] overflow-hidden">
      ...
      <div className="relative z-10 pt-20">
        ...
        <div className="mt-8 flex justify-center">
          <Button className="px-6 py-2 text-sm sm:text-base">View all</Button>
        </div>
      </div>
    </section>
...
<div className='bg-[#f8f4ee] pt-20'>
<section className="bg-[#333230]  py-12 px-4 ">
