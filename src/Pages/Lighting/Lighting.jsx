...
const Lighting = () => {
  ...
  return (
    <div className='font-serif bg-[#f8f4ee]'>
      ...
      <div className="bg-[#f8f4ee] pb-20" data-aos="fade-up">
      ...
      <div className='flex  flex-col justify-center items-center w-full bg-[#f8f4ee] pt-20' data-aos="fade-up">
        ...
        <img src='https://orientelectric.com/cdn/shop/files/Screenshot_2024-09-09_6.47.43_PM_04fb9569-6836-4121-9c6a-c2daee1532a2.png?v=1728022684' alt='bn-image' data-aos="fade-up" />
        <Button className=' flex w-[250px]  mt-6 ' data-aos="fade-up">View Unique Designing Lights</Button>
      </div>
      <div className="w-full py-5 bg-[#f8f4ee] pt-14" data-aos="fade-up">
      ...
      <div className="bg-[#f8f4ee] py-20 px-4 sm:px-10 md:px-20 lg:px-32" data-aos="fade-up">
