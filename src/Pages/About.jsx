...
<section className="relative h-[400px] w-full">
  ...
  <div className="absolute inset-0 bg-black/40  flex flex-col items-center justify-center text-white text-center px-4">
    <h1 className="text-4xl md:text-5xl font-bold mb-3 drop-shadow-lg">About Us</h1>
    <p className="text-base md:text-lg max-w-xl drop-shadow">
      ...
      <section className="py-16 px-4 md:px-20 bg-[#f8f4ee] ">
        <h2 className="text-3xl font-bo  ld text-center mb-8" data-aos="fade-up">Our Vision & Mission</h2>
        <div className="grid md:grid-cols-2 gap-12 items-center" data-aos="fade-up">
          <div className="text-lg space-y-4">
            <p>
              Our <span className="font-semibold">vision</span> is to become the most trusted global IT partner by embracing technology to transform our clients’ future.
            </p>
            <p>
            ...
            <p>
              Our <span className="font-semibold">mission</span> is to deliver technology excellence through empathy, ethics, and innovation.
            </p>
            <p>
      ...
      <section className="py-16 px-4 md:px-20 bg-[#f8f4ee]">
        <h2 className="text-3xl font-bold text-center mb-10" data-aos="fade-up">What We Value</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
          {values.map((val, i) => (
            <div key={i} className="bg-white p-6 rounded-xl shadow hover:shadow-md transition" data-aos="fade-up">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-2">
    {capabilities.map((cap, i) => (
      <div
        key={i}
        className="min-w-[250px] bg-white shadow-md rounded-xl p-6 text-center text-gray-700 hover:bg-orange-50 transition"
        data-aos="fade-up"
      >
        <FaCogs className="text-orange-600 text-3xl mb-2 mx-auto" />
  ...
  <div className="flex flex-col md:flex-row items-center gap-10">
    ...
    <div className="md:w-1/2 w-full text-center md:text-left" data-aos="fade-up">
      <h2 className="text-3xl font-bold mb-4">We Deliver Quality</h2>
      <p className="text-lg">
     ...
     <section className='flex justify-center items-center bg-[#f8f4ee]  grid-col-2 w-[100%]'>
               <div className="py-16 px-4 md:px-20 bg-[#f8f4ee] w-[60%]" data-aos="fade-up">
           ...
           <div className='flex w-[20%] bg-[#f8f4ee] flex-col justify-center items-center' data-aos="fade-up">
