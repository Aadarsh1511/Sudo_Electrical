...
<section className="relative h-[400px] w-full">
  <img
    src="/images/about_ban.jpg" // Correct path (public folder accessible as root)
    alt="About Us Banner"
  ...
  <div className="absolute inset-0 bg-black/40  flex flex-col items-center justify-center text-white text-center px-4">
    ...
    <p className="text-base md:text-lg max-w-xl drop-shadow">
      ...
      <section className="py-16 px-4 md:px-20 bg-[#f8f4ee]">
        ...
        <div className="grid grid-cols-3 flex-row gap-6 py-4 px-2  ">
          {capabilities.map((cap, i) => (
            <div key={i} className="min-w-[250px] bg-white shadow-md rounded-xl p-6 text-center text-gray-700 hover:bg-orange-50 transition">
  ...
  <div className="flex flex-col md:flex-row items-center gap-10">
    ...
    <div className="md:w-1/2 w-full">
      <img
        src="https://orientelectric.com/cdn/shop/files/Who_we_are_timeline_Option_1.jpg?v=1688976483&width=1500" // Replace with your actual image path
