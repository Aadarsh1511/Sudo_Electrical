...
const services = [
  {
    icon: <FaBolt className="text-white text-4xl mb-4 font-serif" />,
  ...
  {
    icon: <FaSolarPanel className="text-white text-4xl mb-4 font-serif" />,
  ...
  {
    icon: <FaTools className="text-white text-4xl mb-4 font-serif" />,
  ...
  {
    icon: <FaChartLine className="text-white text-4xl mb-4 font-serif" />,
  ...
  {
    icon: <FaHome className="text-white text-4xl mb-4 font-serif" />,
...
const ServicesPage = () => {
  ...
  return (
    <section className="bg-[#f8f4ee] py-16 px-6 md:px-20">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 font-serif" data-aos="fade-up"> <span className=" border-red-500 border-b-4 font-serif" >Our</span> Services</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 font-serif" data-aos="fade-up">
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="relative z-10 p-6 h-full flex flex-col justify-center text-center text-white">
              ...
              <p className="text-sm font-serif">{service.desc}</p>
            </div>
          </div>
        ))}
      </div>
